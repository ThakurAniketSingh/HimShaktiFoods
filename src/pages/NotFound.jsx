...
export default function NotFound() {
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-mist px-4 py-20 text-center">
      <div>
        <p className="font-serif text-heading text-[5rem] sm:text-[6rem] leading-none mb-2">404</p>
        <h1 className="font-serif text-heading text-2xl sm:text-3xl mb-3">Page not found</h1>
        ...
        <div className="flex flex-wrap gap-3 justify-center">
          <Link
            to="/"
            className="bg-forest hover:bg-grove dark:bg-sage dark:hover:bg-sage/80 text-white font-bold px-7 py-3.5 rounded-full
