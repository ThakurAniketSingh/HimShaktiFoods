...
// session — anyone visiting the site can submit a review. To keep that
// safe, whatever comes in always lands with status "pending": it's saved
// to the database, but stays invisible on the Home page until an admin
